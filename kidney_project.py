...
__doc__: str = r'''
    >>> Project Group ID : 22
    >>> Project Area : AI/ML and Cloud Computing
    >>> Paper Topic: Kidney Disease Detection and Identification using AI
'''

__authors__: list[str] = ['Rahul Sawhney', 'Sanya Sachdeva', 'Tanya Saraswat']

__authors_qualifications__: dict[str, str] = {
    x: 'Btech CSE, Amity University, Noida' 
    for x in __authors__    
}

__authors_email__: dict[str, Union[list[str], str]] = {
    'Rahul Sawhney' : ['sawhney.rahulofficial@outlook.com', 'rahulsawhney321@gmail.com'],
    'Sanya Sachdeva': '',
    'Tanya Saraswat': ''
}
...
'''
/* 
    #@: Koi extra data analysis operations used krne ho toh yha mention krna.
*/
'''
...
'''
/* 
    #@: Koi extra data transformation operations used krne ho toh yha mention krna.
*/
'''
...
'''
/* 
    #@: Don't Break: PyTorch Starts from here : Feed Forward ANN : 6 * 6 Linear 
*/
'''
...
'''
/* 
    #@: Python's __main__ yha se start hai.   
*/
'''
if __name__.__contains__('__main__'):
    try: 
        ...
        raise ValueError('Data ko download krke yha uska path dalde')
